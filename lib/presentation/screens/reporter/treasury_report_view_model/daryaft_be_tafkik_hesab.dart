...
class TreasuryDaryaftBeTafkikHesabRepViewModel extends ReportsViewModel
    with
        TreasuryDaryaftBeTafkikHesabRepViewModelInput,
        TreasuryDaryaftBeTafkikHesabRepViewModelOutput {
  final TreasuryDaryaftBeTafkikHesabRepUseCase _useCase;
  TreasuryDaryaftAndPardakhtBeTafkikHesabOrTajmieiFilterModel _filterModel =
      TreasuryDaryaftAndPardakhtBeTafkikHesabOrTajmieiFilterModel("دریافت به تفکیک پرداخت کننده");

  TreasuryDaryaftBeTafkikHesabRepViewModel(this._useCase);
...
abstract class TreasuryDaryaftBeTafkikHesabRepViewModelInput {}

abstract class TreasuryDaryaftBeTafkikHesabRepViewModelOutput {}
