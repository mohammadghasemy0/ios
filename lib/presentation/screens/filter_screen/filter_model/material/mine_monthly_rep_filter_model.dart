...
class MineMonthlyRepFilterModel extends FilterModel<MaterialMineMonthlyRepRequest> {
  ...
  MineMonthlyRepFilterModel(String title): super(title) {
    _items = {
  ...
  @override
  MaterialMineMonthlyRepRequest getRequest() {
    return MaterialMineMonthlyRepRequest(
        (_items['date'] as FromToDateFilterField).value.start.year.toString(),
  ...
  @override
  MineMonthlyRepFilterModel clone() {
    final template = MineMonthlyRepFilterModel(title);
    template.items = {
