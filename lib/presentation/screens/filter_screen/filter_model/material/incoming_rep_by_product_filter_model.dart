...
class IncomingRepByProductFilterModel extends FilterModel<MaterialIncomingRepByProductRequest> {
  ...
  IncomingRepByProductFilterModel(String title): super(title) {
    _items = {
  ...
  // String persianFromStrDate,   String persianToStrDate,   String dbName,   int costCenterId,   List  productIds
  @override
  MaterialIncomingRepByProductRequest getRequest() {
    return MaterialIncomingRepByProductRequest(
  ...
  @override
  IncomingRepByProductFilterModel clone() {
    final template = IncomingRepByProductFilterModel(title);
    template.items = {
