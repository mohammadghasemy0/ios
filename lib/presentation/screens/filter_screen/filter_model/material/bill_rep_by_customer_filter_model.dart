...
class BillRepByCustomerFilterModel extends FilterModel<MaterialBillRepByCustomerRequest> {
  ...
  BillRepByCustomerFilterModel(String title): super(title) {
    _items = {
  ...
  @override
  MaterialBillRepByCustomerRequest getRequest() {
    return MaterialBillRepByCustomerRequest(
  ...
  @override
  BillRepByCustomerFilterModel clone() {
    final template = BillRepByCustomerFilterModel(title);
    template.items = {
