...
class MineTransportToSaleRatioRepFilterModel extends FilterModel<MaterialMineTransportToSaleRatioReportRequest> {
  ...
  MineTransportToSaleRatioRepFilterModel(String title): super(title) {
    _items = {
  ...
  @override
  MaterialMineTransportToSaleRatioReportRequest getRequest() {
    return MaterialMineTransportToSaleRatioReportRequest(
  ...
  @override
  MineTransportToSaleRatioRepFilterModel clone() {
    final template = MineTransportToSaleRatioRepFilterModel(title);
    template.items = {
