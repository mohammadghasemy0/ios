...
class MineDailyRepFilterModel extends FilterModel<MaterialMineDailyRepRequest> {
  ...
  MineDailyRepFilterModel(String title): super(title) {
    _items = {
  ...
  @override
  MaterialMineDailyRepRequest getRequest() {
    return MaterialMineDailyRepRequest(
  ...
  @override
  MineDailyRepFilterModel clone() {
    final template = MineDailyRepFilterModel(title);
    template.items = {
