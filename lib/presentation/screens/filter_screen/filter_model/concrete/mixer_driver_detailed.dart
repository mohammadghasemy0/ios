...
class ConcreteMixerDriverDetailedRepFilterModel
    extends FilterModel<ConcreteMixerDriverDetailedRepRequest> {
  ...
  ConcreteMixerDriverDetailedRepFilterModel(String title): super(title) {
    _items = {
  ...
  @override
  ConcreteMixerDriverDetailedRepRequest getRequest() {
    return ConcreteMixerDriverDetailedRepRequest(
  ...
  @override
  ConcreteMixerDriverDetailedRepFilterModel clone() {
    final template = ConcreteMixerDriverDetailedRepFilterModel(title);
    template.items = {
